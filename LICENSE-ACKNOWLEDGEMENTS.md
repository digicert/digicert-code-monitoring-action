...
| --- | --- | --- | --- | --- |
| actions/checkout | v4 | MIT | Source checkout in composite action | https://github.com/actions/checkout |
| github/codeql-action | v3 | MIT (plus CodeQL Terms) | CodeQL init and analysis steps | https://github.com/github/codeql-action |
| actions/upload-artifact | v4 | MIT | Upload SARIF and SBOM artifacts | https://github.com/actions/upload-artifact |
| aquasecurity/trivy-action | master | Apache-2.0 | SBOM generation step | https://github.com/aquasecurity/trivy-action |
